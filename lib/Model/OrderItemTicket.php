...
/**
 * OrderItemTicket Class Doc Comment
 *
 * @category Class
 * @package  Kinoheld\GenericProviderClient
 * @author   OpenAPI Generator team
 ...
 */
class OrderItemTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemTicket';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('seat_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the ticket for display to the user.
     *
     * @return self
     */
     ...
     * Sets seat_id
     *
     * @param int|null $seat_id If the order is attached to a show/event with seat selection, this field is required and must contain the seat ID that this ticket applies to.
     *
     * @return self
     */
    ...
    {
        if (is_null($seat_id)) {
            throw new \InvalidArgumentException('non-nullable seat_id cannot be null');
        }
