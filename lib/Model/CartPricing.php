 ...
 */
class CartPricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_pricing';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount The total amount of the cart, the sum of all items and products without discounts.
     *
     * @return self
     */
     ...
     * Sets payment_amount
     *
     * @param float|null $payment_amount The amount to pay by user for this cart.
     *
     * @return self
     */
