...
self::SALES_CHANNELS_CALL,        ];
     ...
     * Sets description
     *
     * @param string $description Description displayed to the user. [Currently not supported]
     *
     * @return $this
     */
     ...
     * Sets hint
     *
     * @param string $hint Hint displayed to the user if category is selected. [Currently not supported]
     *
     * @return $this
     */
