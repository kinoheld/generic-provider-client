 ...
 */
class PriceAreaItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceAreaItem';
    ...
    */
    ...
    public function setPriceCategories($price_categories)
    {
        if (is_null($price_categories)) {
            throw new \InvalidArgumentException('non-nullable price_categories cannot be null');
        }
