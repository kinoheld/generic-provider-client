...
/**
 * OrderAllOfPricing Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderAllOfPricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_allOf_pricing';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount The total amount of the order, the sum of all items without discounts.
     *
     * @return self
     */
     ...
     *
     * @param float|null $discounted_amount The amount discounted by attached discounts.
     *
     * @return self
     */
     ...
     * Sets payment_amount
     *
     * @param float|null $payment_amount The amount to pay by user for this order.
     *
     * @return self
     */
