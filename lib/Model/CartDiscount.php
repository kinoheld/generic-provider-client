 ...
 */
class CartDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartDiscount';
    ...
    */
     ...
     *
     * @param float|null $remaining_amount The remaining amount of the discount.
     *
     * @return self
     */
     ...
     * Sets initial_amount
     *
     * @param float|null $initial_amount The initial amount of the discount.
     *
     * @return self
     */
     ...
     * Sets applied_amount
     *
     * @param float|null $applied_amount The amount of the discount applied to the cart.
     *
     * @return self
     */
