...
class LoyaltyApi
{
     ...
     */
    public function loyaltyGet($chainId, $cinemaId, $cardNumber, $email = null)
    {
        list($response) = $this->loyaltyGetWithHttpInfo($chainId, $cinemaId, $cardNumber, $email);
        return $response;
    }
     ...
     */
    public function loyaltyGetWithHttpInfo($chainId, $cinemaId, $cardNumber, $email = null)
    {
        $returnType = '\kinoheld\GenericProviderClient\Model\Loyalty';
        $request = $this->loyaltyGetRequest($chainId, $cinemaId, $cardNumber, $email);
     ...
     */
    public function loyaltyGetAsync($chainId, $cinemaId, $cardNumber, $email = null)
    {
        return $this->loyaltyGetAsyncWithHttpInfo($chainId, $cinemaId, $cardNumber, $email)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loyaltyGetAsyncWithHttpInfo($chainId, $cinemaId, $cardNumber, $email = null)
    {
        $returnType = '\kinoheld\GenericProviderClient\Model\Loyalty';
        $request = $this->loyaltyGetRequest($chainId, $cinemaId, $cardNumber, $email);
     ...
     */
    protected function loyaltyGetRequest($chainId, $cinemaId, $cardNumber, $email = null)
    {
        // verify the required parameter 'chainId' is set
        if ($chainId === null || (is_array($chainId) && count($chainId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $chainId when calling loyaltyGet'
            );
        }
        // verify the required parameter 'cinemaId' is set
        if ($cinemaId === null || (is_array($cinemaId) && count($cinemaId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cinemaId when calling loyaltyGet'
            );
        }
        // verify the required parameter 'cardNumber' is set
        if ($cardNumber === null || (is_array($cardNumber) && count($cardNumber) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cardNumber when calling loyaltyGet'
            );
        }
