...
class DiscountApi
{
    ...
    {
        list($response) = $this->discountGetWithHttpInfo($chain_id, $cinema_id, $code, $contentType);
        return $response;
    }

    /**
     * Operation discountGetWithHttpInfo
     *
     * get the discount
     *
     * @param  int $chain_id The chain ID the cinema belongs to. (required)
     ...
     */
    public function discountGetAsync($chain_id, $cinema_id, $code, string $contentType = self::contentTypes['discountGet'][0])
    {
        return $this->discountGetAsyncWithHttpInfo($chain_id, $cinema_id, $code, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation discountGetAsyncWithHttpInfo
     *
     * get the discount
     *
     * @param  int $chain_id The chain ID the cinema belongs to. (required)
     ...
     */
    public function discountGetRequest($chain_id, $cinema_id, $code, string $contentType = self::contentTypes['discountGet'][0])
    {
        ...
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $code when calling discountGet'
            );
        }
